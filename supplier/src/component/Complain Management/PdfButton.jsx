    ...
    logoImage.onload = () => {
      ...
      const docDefinition = {
        content: [
          ...
          { text: 'Colombo,' },
          { text: '\n' },
          { text: `User Complaint`, style: 'header' },
          { text: '\n' },
          {
            layout: {
            ...
            table: {
              widths: ['auto', '*'],
              body: [
              [{ text: 'Name', style: 'label' }, complain.name],
              [{ text: 'Email', style: 'label' }, complain.email],
              [{ text: 'Complaint', style: 'label' }, complain.message],
          ...
          { text: '\n' }, { text: '\n' }, { text: '\n' }, { text: '\n' }, { text: '\n' },
          { text: 'This report Contains complaint details for BuySell Nexus company (PVT) LTD.' },
          { text: '\n' },
          { text: '\n' },
      ...
      pdfMake.createPdf(docDefinition).download(`Compalint.pdf`);
    };
  };
